            ...
            <form action="{{ route('packages.update', $package) }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" class="premium-input" value="{{ $package->name }}" placeholder="e.g. Pro Membership" required>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold uppercase tracking-widest text-text-muted mb-2">Price ($)</label>
                            <input type="number" name="price" class="premium-input" value="{{ $package->price }}" placeholder="99" required>
                        </div>
                        <div>
                            <label class="block text-xs font-bold uppercase tracking-widest text-text-muted mb-2">Duration (Days)</label>
                            <input type="number" name="duration_days" class="premium-input" value="{{ $package->duration_days }}" placeholder="30" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="features-container" class="space-y-3">
                            ...
                            <div class="flex gap-2">
                                <input type="text" name="features[]" class="premium-input" value="{{ $feature }}" placeholder="New Feature">
                    ...
                    <div class="pt-6 border-t border-glass-border flex gap-4">
                        <button type="submit" class="btn-premium flex-1">Update Package</button>
