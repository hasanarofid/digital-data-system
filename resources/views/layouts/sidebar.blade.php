<aside class="sidebar flex flex-col" :class="sidebarOpen ? 'open' : ''">
    ...
    <nav class="flex flex-col gap-2 flex-1">
        ...
        <div class="mt-4 mb-2 px-4 text-[10px] uppercase tracking-widest text-text-muted font-bold">Data Management</div>
        ...
        <div class="mt-4 mb-2 px-4 text-[10px] uppercase tracking-widest text-text-muted font-bold">System Info</div>
